...
class NoteButton{
  ...
  boolean isClicked(){ //use this in an if statement to check if the button has been clicked
    return clicked;
  }
...
//Had to connect each frequency to its corresponding button using a more tedious method, but it still works
  ...
  //** must check if it's within rectangle again, otherwise the click can register anywhere on screen vv
   //Cmaj button
   if (notebutton[0].isClicked() && mouseX >= 10 && mouseX <= 40 && mouseY >= 280 && mouseY <= 310){
   ...
   //D minor button  
   if (notebutton[1].isClicked() && mouseX >= 45 && mouseX <= 75 && mouseY >= 280 && mouseY <= 310){
   ...
   //E minor button  
   if (notebutton[2].isClicked() && mouseX >= 80 && mouseX <= 110 && mouseY >= 280 && mouseY <= 310){
   ...
   //Fmaj button  
   if (notebutton[3].isClicked() && mouseX >= 115 && mouseX <= 145 && mouseY >= 280 && mouseY <= 310){
  ...
  //Gmaj button  
   if (notebutton[4].isClicked() && mouseX >= 150 && mouseX <= 180 && mouseY >= 280 && mouseY <= 310){
  ...
  //A minor button  
   if (notebutton[5].isClicked() && mouseX >= 185 && mouseX <= 215 && mouseY >= 280 && mouseY <= 310){
  ...
  //B dim button  
   if (notebutton[6].isClicked() && mouseX >= 220 && mouseX <= 250 && mouseY >= 280 && mouseY <= 310){
   ...
   //C5 maj button  
   if (notebutton[7].isClicked() && mouseX >= 255 && mouseX <= 285 && mouseY >= 280 && mouseY <= 310){
